  ...
  <header id="header" class="clear"> 
    ...
    <h1><a class="nav-link" href="<?php echo base_url();?>Inicio">CONSULTAS EXTERNAS EN EL POLICLÍNICO DOCENTE ÁNGEL ORTIZ VÁZQUEZ</a></h1>
    </div>
    <!-- ################################################################################################ -->
    <!-- ################################################################################################ -->
    ...
    <ul class=" navbar-nav navbar-nav-right">
        <li class="nav-item dropdown ">
          <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
            <div class="navbar-profile " style=" display: flex;  justify-content: center; align-items: center;">
            <img src="<?php echo base_url();?>assets/dist/img/userDefault.jpg" class="img-circle elevation-2" style="width: 40px;" alt="User Image">
              <p class="mb-0 d-none d-sm-block navbar-profile-name" style="padding: 10px"><?php echo $this->session->userdata('nombre_usuario');?></p>
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
            ...
            <a class="dropdown-item preview-item"  data-toggle='modal' data-target='#setpass'>
              ...
              <div class="preview-item-content" style="cursor: pointer; display: flex;  justify-content: left; align-items: center;">
            ...
            <a class="dropdown-item preview-item" href="<?php echo base_url();?>clogin/CerrarSesion">
              ...
              <div class="preview-item-content" style=" display: flex;  justify-content: left; align-items: center;">
    ...
    <nav id="mainav" class="fl_right">
      ...
      <ul class="clear">
        <li class="active"> <a class="nav-link" href="<?php echo base_url();?>Inicio">Inicio</a> </li>
