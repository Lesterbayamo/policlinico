...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-10">
        <b><h1><i class="fa fa-flask"></i> GESTIONAR ESPECIALIDADES</h1></b>
      </div>
      <div class="col-sm-2">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <table style="width: 100%" id="tb_especialidad" alin="center" class="table table-bordered  table-hover table-condensed">
              <thead>
                <tr>           
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formAdd" action="<?php echo base_url(); ?>especialidad_c/Add" method="POST">
          <div class="card-body">
            <div class="row">
              <div class="col-12">              
                ...
                <div class="form-group" >
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nombre_especialidad_add" name="nombre_especialidad_add" pattern="^[a-zA-ZáéíóúÁÉÍÓÚÑñ\s]{5,100}$" title="Formato válido: Solo texto. Entre 5 y 100 carácter" required>
                  </div>
                  <!-- /.input group -->
                </div>
                <div class="form-group" >
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="abreviatura_add" name="abreviatura_add" pattern="^[a-zA-Z\s]{2,10}$" title="Formato válido: Solo texto. Entre 2 y 10 carácter" required>
                  </div>
                  <!-- /.input group -->
                </div>               
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text bg-dark"><i class="fas fa-spell-check"></i></span>
                      <textarea name="descripcion_add" id="descripcion_add" cols="38" rows="5" required></textarea>                    
                    </div>
                  </div>
                  <!-- /.input group -->
                </div>                  
  ...
  <div class="modal-dialog modal-md">
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h4 class="modal-title"><b> <i class="fa fa-edit"></i> MODIFICAR ESPECIALIDAD</b></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" data-toggle = "tooltip" data-placement = "top" title="Cerrar">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form id="formUpd" action="<?php echo base_url(); ?>especialidad_c/Upd" method="POST">
          <div class="card-body">
            <div class="row">
              <div class="col-12">              
              ...
              <div class="form-group" >
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nombre_especialidad_upd" name="nombre_especialidad_upd" pattern="^[a-zA-ZáéíóúÁÉÍÓÚÑñ\s]{5,100}$" title="Formato válido: Solo texto. Entre 5 y 100 carácter" required>
                  </div>
                  <!-- /.input group -->
                </div>
                <div class="form-group" >
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="abreviatura_upd" name="abreviatura_upd" pattern="^[a-zA-Z\s]{2,10}$" title="Formato válido: Solo texto. Entre 2 y 10 carácter" required>
                  </div>
                  <!-- /.input group -->
                </div>               
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text bg-dark"><i class="fas fa-spell-check"></i></span>
                      <textarea name="descripcion_upd" id="descripcion_upd" cols="38" rows="5" required></textarea>                    
                    </div>
                  </div>
                  <!-- /.input group -->
                </div>   
...
<div class="modal fade" id="Del">
  <div class="modal-dialog modal-lm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formCampDel" action="<?php echo base_url(); ?>especialidad_c/Delete" method="POST">
        <div class="card-body">  
          <!-- Parametros ocultos -->
...
<div class="modal fade" id="status">
  <div class="modal-dialog modal-lm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formCampDel" action="<?php echo base_url(); ?>especialidad_c/Set_estado" method="POST">
        <div class="card-body">  
          <!-- Parametros ocultos -->
