...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-10">
        <b><h1><i class="fas fa-layer-group"></i> GESTIONAR GRUPOS DE EDADES</h1></b>
      </div>
      <div class="col-sm-2">
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <table style="width: 100%" id="tb_edades" alin="center" class="table table-bordered  table-hover table-condensed">
              <thead>
                <tr>           
              ...
              <div class="col-12">              
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text bg-dark"><i class="fas fa-spell-check"></i></span>
                      <input type="text" class="form-control" id="rango_add" name="rango_add" required>
                    </div>
                      <!-- <div class="input-group-prepend">
                      <label>Meses</label>
            ...
            <div class="row">
              ...
              <div class="form-group ">
                  ...
                  <div class="input-group-prepend">
                    ...
                    <select class="select2" style="width: 80%" id="especialidad_upd" name="especialidad_upd" required>
                      <option value="">--Select--</option>                        
                    </select>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <div class="input-group-prepend">
                      <span class="input-group-text bg-dark"><i class="fas fa-spell-check"></i></span>
                      <input type="text" class="form-control" id="rango_upd" name="rango_upd" required>
                    </div>
                  </div>
                  <!-- /.input group -->
                </div>  
